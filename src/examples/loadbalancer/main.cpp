...
/**
 * @brief master send a double to any of the workers, wait for completion, verify result
...
/**
 * @brief messageHandler On the worker side, take the received value, multiply by 2, return
 * @param buffer
 * @param size
 * @param jobId
 * @param userData
...
void worker()
{
    loadBalancerWorkerRun(messageHandler, NULL);
}
