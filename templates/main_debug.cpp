...
int main(int argc, char** argv) {
    ...
    std::string inFileArgument =
        "/home/dweindl/src/benchmarkProblem/"
        "20190205221009_Speedy_v4_Jan2019_generic_degradation_r415549/"
        "Speedy_v4_Jan2019_generic_degradation_r415549.bak.h5";
    ...
    auto optimizationParams =
        options->getStartingPoint(dataProvider.getHdf5File(), start_idx);
    dataProvider.updateSimulationParametersAndScale(
        condition_idx, optimizationParams, *model);
