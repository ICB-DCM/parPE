...
Model *getModel() { return new Model_model_steadystate(); }
...
int fJBand(long int N, long int mupper, long int mlower, realtype t, N_Vector x,
    ...
    return JBand_model_steadystate(N, mupper, mlower, t, x, xdot, J, user_data,
                                   tmp1, tmp2, tmp3);
}
...
int fJBandB(long int NeqBdot, long int mupper, long int mlower, realtype t,
    ...
    return JBandB_model_steadystate(NeqBdot, mupper, mlower, t, x, xB, xBdot,
                                    JB, user_data, tmp1B, tmp2B, tmp3B);
}
