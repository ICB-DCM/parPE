...
#define SWIGTYPE_p_std__unique_ptrT_amici__Model_t swig_types[5]
...
/*-----------------------------------------------
              @(target):= _lucarelli_12.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__lucarelli_12

#else
#  define SWIG_init    init_lucarelli_12

#endif
#define SWIG_name    "_lucarelli_12"
