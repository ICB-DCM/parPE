...
sources = ['swig/lucarelli_12.i', *getModelSources()]
...
# Build shared object
model_module = Extension('lucarelli_12/_lucarelli_12',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'lucarelli_12',
...
setup(
    name='lucarelli_12',
    version='0.1.0',
    description='AMICI-generated module for model lucarelli_12',
