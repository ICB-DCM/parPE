...
class HDF5Exception : public std::exception {
  public:
    ...
    explicit HDF5Exception(char const* format, ...);
 ...
 */
H5::H5File hdf5CreateFile(std::string const& filename, bool overwrite = false);
...
hdf5Read1dStringDataset(const H5::H5File& file, std::string const& datasetPath);
