 ...
 */
template <typename X> class Model {
  public:
...
/**
 * @brief The LinearModel class represents a linear model y = Ax + b with
 * feature matrix A and parameters [x, b].
 */
...
class LinearModel : public Model<std::vector<double>> {
  public:
    ...
    /**
     * @brief Evaluate linear model with the given parameter on the given
     * dataset
     * @param parameters
     * @param features
     * @param outputs
...
/**
 * @brief The LinearModelMSE class is a wrapper around LinearModel implementing
