...
class LocalOptimizationIpoptTNLP : public Ipopt::TNLP {
  public:
     ...
     *
     * Note: Failure in eval_f (i.e. returning non-finite value or false) will
     * make IpOpt try a new step, unless this happens at the starting point.
     * However, if eval_f succeeds, but eval_grad_f fails, then IpOpt will
     * terminate.
     *
     * @param n
     * @param x
    ...
    void finalize_solution(
        ...
        Ipopt::Index n,
        Ipopt::Number const* x,
        Ipopt::Number const* z_L,
        Ipopt::Number const* z_U,
        Ipopt::Index m,
        Ipopt::Number const* g,
