...
/**
 * @brief The StandaloneSimulator class is for running simulations for a given
 * dataset and given parameters after optimization in parallel or in sequential
 * mode and saving the simulation results.
 *
...
class StandaloneSimulator
{
  public:
     ...
     * HDF5 file at the given location
  ...
  private:
    ...
    /** Number of simulations to be sent to workers within one package (when
     * running with MPI). */
