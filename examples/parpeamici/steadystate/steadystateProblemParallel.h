...
/**
 * @brief The ExampleSteadystateGradientFunctionParallel class evaluates an
 * ODE-constrained objective function in paralell.
 */

class ExampleSteadystateGradientFunctionParallel
